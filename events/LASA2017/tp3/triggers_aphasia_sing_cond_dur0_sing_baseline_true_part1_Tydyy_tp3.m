...
panames(ismember({panames.name},{'.','..','ID109'}))=[];
name{1}='ID102_3_fMRI_singing_aphasia_Tydyy_male.log';res(1)=2;
name{2}='ID104_3_fMRI_singing_aphasia_Tydyy_female.log';res(2)=2;
name{3}='ID110_3_fMRI_singing_aphasia_Tydyy_male.log';res(3)=2;
name{4}='ID112_3_fMRI_singing_aphasia_Tydyy_male.log';res(4)=2;
name{5}='ID113_3_fMRI_singing_aphasia_Tydyy_female.log';res(5)=2;
name{6}='ID114_3_fMRI_singing_aphasia_Tydyy_male.log';res(6)=2;
name{7}='ID116_3_fMRI_singing_aphasia_Tydyy_male.log';res(7)=2;
name{8}='ID121_3_fMRI_singing_aphasia_Tydyy_female.log';res(8)=2;
name{9}='ID122_3_fMRI_singing_aphasia_Tydyy_female.log';res(9)=2;
name{10}='ID123_3_fMRI_singing_aphasia_Tydyy_female.log';res(10)=2;
name{11}='ID124_3_fMRI_singing_aphasia_Tydyy_female.log';res(11)=2;
name{12}='ID134_3_fMRI_singing_aphasia_Tydyy_female.log';res(12)=2;
