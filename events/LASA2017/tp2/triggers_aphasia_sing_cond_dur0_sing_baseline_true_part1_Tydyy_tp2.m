...
name{1}='ID102_2_fMRI_singing_aphasia_Tydyy_male.log';res(1)=2;
name{2}='ID104_2_fMRI_singing_aphasia_Tydyy_female.log';res(2)=2;
name{3}='ID110_2_fMRI_singing_aphasia_Tydyy_male.log';res(3)=2;
name{4}='ID112_2_fMRI_singing_aphasia_Tydyy_male.log';res(4)=2;
name{5}='ID113_2_fMRI_singing_aphasia_Tydyy_female.log';res(5)=2;
name{6}='ID114_2_fMRI_singing_aphasia_Tydyy_male.log';res(6)=2;
name{7}='ID116_2_fMRI_singing_aphasia_Tydyy_male.log';res(7)=2;
name{8}='ID121_2_fMRI_singing_aphasia_Tydyy_female.log';res(8)=2;
name{9}='ID122_2_fMRI_singing_aphasia_Tydyy_female.log';res(9)=2;
name{10}='ID124_2_fMRI_singing_aphasia_Tydyy_female.log';res(10)=2;
name{11}='ID134_2_fMRI_singing_aphasia_Tydyy_female.log';res(11)=2;
