...
%SINGING PERFORMANCE SUMMARY: sub1(ID102) some base and singm false; sub2(ID104)all trials correct;
%sub3(ID110) all trials correct, sub4(ID112) some base &&
%lis false, sub5(ID113) all trials correct, sub6(ID114) some singa &&
%singm false, sub7(ID116) some base, lis, singa && singm false,
%sub8(ID121) some singa false, sub9(ID122) some lis and singm false,
%sub10(ID124) some lis, singa && singm false, sub11(ID134) some lis && base false
for sub=1:numel(panames)
    ...
    elseif sub==2  || sub==3  || sub==5% no incorrect trials
