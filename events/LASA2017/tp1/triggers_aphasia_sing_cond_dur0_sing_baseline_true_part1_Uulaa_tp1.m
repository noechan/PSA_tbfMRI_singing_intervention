...
name{1}='ID102_1_fMRI_singing_aphasia_Uulaa_male.log';res(1)=2;
name{2}='ID104_1_fMRI_singing_aphasia_Uulaa_female.log';res(2)=2;
name{3}='ID110_1_fMRI_singing_aphasia_Uulaa_male.log';res(3)=2;
name{4}='ID112_1_fMRI_singing_aphasia_Uulaa_male.log';res(4)=2;
name{5}='ID113_1_fMRI_singing_aphasia_Uulaa_female.log';res(5)=2;
name{6}='ID114_1_fMRI_singing_aphasia_Uulaa_male.log';res(6)=2;
name{7}='ID116_1_fMRI_singing_aphasia_Uulaa_male.log';res(7)=2;
name{8}='ID121_1_fMRI_singing_aphasia_Uulaa_female.log';res(8)=2;
name{9}='ID122_1_fMRI_singing_aphasia_Uulaa_female.log';res(9)=2;
name{10}='ID124_1_fMRI_singing_aphasia_Uulaa_female.log';res(10)=2;
name{11}='ID134_1_fMRI_singing_aphasia_Uulaa_female.log';res(11)=2;
