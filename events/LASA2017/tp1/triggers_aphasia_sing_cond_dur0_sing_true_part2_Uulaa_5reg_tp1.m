...
panames(ismember({panames.name},{'.','..','ID106','ID109','ID123','ID127','ID128'}))=[];
    %SINGING PERFORMANCE SUMMARY: sub1(ID102) some base, lis and singm false, sub2(ID104) some lis and singa false,
    ...sub3(ID110)some base, lis & singm false, sub4(ID112) some singa false,
    ...sub5(ID113) all trials correct, sub6(ID114) some lis, base& singm false, sub7(ID116) some lis, base, singa & singm false
    ...sub8(ID121) some lis false, sub9(ID122) some lis, singa & singm false,
    ...sub10(ID124) some lis, base, singa & singm false,
    ...sub11(ID134) some singa & singm false
...
if sub~=5
  ...
  elseif sub==5%all trials correct
