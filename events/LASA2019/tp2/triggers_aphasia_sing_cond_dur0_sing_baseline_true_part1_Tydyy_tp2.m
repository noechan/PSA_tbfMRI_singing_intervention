...
name{1}='ID138_2_fMRI_singing_aphasia_Tydyy_female.log';res(1)=2;
name{2}='ID139_2_fMRI_singing_aphasia_Tydyy_male.log';res(2)=2;
name{3}='ID140_2_fMRI_singing_aphasia_Tydyy_male.log';res(3)=2;
name{4}='ID142_2_fMRI_singing_aphasia_Tydyy_male.log';res(4)=2;
name{5}='ID145_2_fMRI_singing_aphasia_Tydyy_female.log';res(5)=2;
name{6}='ID146_2_fMRI_singing_aphasia_Tydyy_female.log';res(6)=2;
name{7}='ID150_2_fMRI_singing_aphasia_Tydyy_female.log';res(7)=2;
name{8}='ID153_2_fMRI_singing_aphasia_Tydyy_male.log';res(8)=2;
