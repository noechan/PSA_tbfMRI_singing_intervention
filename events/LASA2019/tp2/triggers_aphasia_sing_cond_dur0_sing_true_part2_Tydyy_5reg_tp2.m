...
%SINGING PERFORMANCE SUMMARY: sub1(ID138) some lis & singa false, sub 2(ID139) all trials
%true, sub3(ID140) & sub4 (ID142) some base and lis trials false,
%sub5(ID145) all lis false, sub6 (ID146) some lis false,
%sub7(ID150) some lis false, sub8(ID153) all lis false
for sub=1:numel(panames)
    ...
    if sub~=5 && sub~=8 %all listen incorrect
