...
panames(ismember({panames.name},{'.','..','ID135','ID136','ID137','ID148','ID149','ID158','PPA'}))=[];
     %SINGING PERFORMANCE SUMMARY: sub1(ID138) some lis, base, singa and singm false, sub2(ID139) && sub3(ID140) && sub4(ID142) some lis false
     %sub5(ID145) some base, lis, singa && singm false, sub6(ID146) some lis and singa false
     ...sub7 (ID150) some lis & singm false, sub8(ID153) all lis & singm false
for sub=1%:numel(panames)
    ...
    if sub~=8 %all sing memo incorrect
  ...
  elseif sub==8 %all sing memo incorrect
