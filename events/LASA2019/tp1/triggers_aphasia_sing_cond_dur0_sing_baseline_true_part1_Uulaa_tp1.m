...
data_path='/Volumes/LASA/Aphasia_project/tb-fMRI/recordings/LASA2019/Noise_reduction_copy/Uulaa/';
panames=dir(data_path);
panames(ismember({panames.name},{'.','..','ID135','ID136','ID137','ID148','ID149','ID158','PPA'}))=[];
name{1}='ID138_1_fMRI_singing_aphasia_Uulaa_female.log';res(1)=2;
name{2}='ID139_1_fMRI_singing_aphasia_Uulaa_male.log';res(2)=2;
name{3}='ID140_1_fMRI_singing_aphasia_Uulaa_male.log';res(3)=2;
name{4}='ID142_1_fMRI_singing_aphasia_Uulaa_male.log';res(4)=2;
name{5}='ID145_1_fMRI_singing_aphasia_Uulaa_female.log';res(5)=2;
name{6}='ID146_1_fMRI_singing_aphasia_Uulaa_female.log';res(6)=2;
name{7}='ID150_1_fMRI_singing_aphasia_Uulaa_female.log';res(7)=2;
name{8}='ID153_1_fMRI_singing_aphasia_Uulaa_male.log';res(8)=2;
